...
public class Q19MapJob extends Configured implements Tool {
    public static class myMap extends Mapper<AvroKey<Record>, NullWritable, IntWritable, Text> {
        ...
        public void map(AvroKey<Record> key, NullWritable value, Context context)
            ...
            context.write(new IntWritable(1), new Text(1 + "|" + result));
        }
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "Q19MapJob");
        job.setJarByClass(Q19MapJob.class);
        ...
        job.setInputFormatClass(InputFormat_Q19.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new Q19MapJob(), args);
        System.exit(res);
    }
}
