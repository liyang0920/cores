...
public class Q14MapJobText extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "Q14MapJobText");
        job.setJarByClass(Q14MapJobText.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new Q14MapJobText(), args);
        System.exit(res);
    }
}
