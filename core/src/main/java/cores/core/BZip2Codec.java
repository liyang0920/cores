...
public class BZip2Codec extends Codec {
    ...
    @Override ByteBuffer compress(ByteBuffer uncompressedData) throws IOException {
    ...
    @Override ByteBuffer decompress(ByteBuffer compressedData) throws IOException {
